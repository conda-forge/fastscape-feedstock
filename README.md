...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fastscape-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8157&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fastscape-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fastscape` can be installed with:

```
conda install fastscape
```

It is possible to list all of the versions of `fastscape` available on your platform with:
